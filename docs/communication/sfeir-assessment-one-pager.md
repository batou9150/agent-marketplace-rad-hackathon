...
**Destinataires** : Directeurs de Compte, Practice Leads & Consultants SFEIR  
...
```mermaid
flowchart LR
    A["<b>Jour 1 : Cadrage & Collecte</b><br/>• Cartographie des prototypes IA<br/>• Configuration de Vibe Guard dans le projet client"] --> B["<b>Jour 2 : Scan Automatisé & Analyse</b><br/>• Scan des bases de code (Zero-Egress)<br/>• Analyse des 4 familles (AUTH, SECRETS, LLM-GOV, NET-ISO)"]
    B --> C["<b>Jour 3 : Restitution & Roadmap</b><br/>• Rapport exécutif pour CISO & CTO<br/>• Scripts Terraform & configs Cloud Run prêts à l'emploi"]
```
...
**Contact Référent SFEIR** : Practice Lead Cloud & GenAI — `vibe-guard-team@sfeir.com`
